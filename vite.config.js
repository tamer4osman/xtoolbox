  ...
  server: {
    ...
    headers: {
      ...
      "Content-Security-Policy":
        "default-src 'self'; script-src 'self' 'wasm-unsafe-eval' 'unsafe-eval' 'unsafe-inline' blob: https://cdn.jsdelivr.net https://unpkg.com https://fonts.googleapis.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://cdn.jsdelivr.net; img-src 'self' data: blob: https://covers.openlibrary.org https://world.openfoodfacts.org https://api.coingecko.com; media-src 'self' blob:; connect-src 'self' https://unpkg.com https://cdn.jsdelivr.net https://wttr.in https://api.coingecko.com https://api.dictionaryapi.dev https://earthquake.usgs.gov https://api.waqi.info https://date.nager.at https://openlibrary.org https://cloudflare-dns.com https://dns.google https://*.openfoodfacts.org; font-src 'self' https://fonts.gstatic.com https://cdn.jsdelivr.net; worker-src 'self' blob:; frame-src 'self' blob:"
    }
  },
  preview: {
    port: 4173,
