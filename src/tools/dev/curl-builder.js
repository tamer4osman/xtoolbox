...
export const toolConfig = {
  ...
  category: 'dev',
  description: 'Build cURL commands visually. Select method, add headers, set body, and copy the generated command.',
  icon: '🔗',
  accept: null,
  maxSizeMB: null,
  keywords: ['curl', 'curl command', 'http request', 'api testing', 'rest client', 'curl generator'],
  steps: ['Choose HTTP method and enter URL', 'Add headers (optional)', 'Set request body (optional)', 'Copy the generated curl command'],
  faqs: [
    { question: 'What HTTP methods are supported?', answer: 'GET, POST, PUT, PATCH, DELETE, HEAD, OPTIONS.' },
    { question: 'Can I add custom headers?', answer: 'Yes. Click "Add Header" to add key-value pairs. Remove any header with the × button.' },
    { question: 'Is the command safe to use?', answer: 'The tool generates standard curl syntax. Review the command before running it in your terminal.' }
  ]
};
