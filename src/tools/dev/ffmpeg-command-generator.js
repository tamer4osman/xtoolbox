export const toolConfig = {
  ...
  category: "dev",
  description:
    "Build FFmpeg commands visually with input/output formats, codecs, filters, and presets.",
  icon: "🎬",
...
function bindEvents(container) {
  ...
  container
    ...
    .addEventListener("click", () => generateCommand(container));
...
function applyPreset(container, preset) {
  ...
  const presets = {
    ...
    gif: {
      ...
      audioCodec: "",
      audioBitrate: "",
      customArgs: '-filter_complex "[0:v] fps=15,scale=320:-1 [s]; [s] palettegen" -y palette.png'
    },
    "extract-audio": {
      format: "mp3",
      videoCodec: "",
