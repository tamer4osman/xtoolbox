...
const themes = [
  { name: 'Monokai', bg: '#272822', fg: '#f8f8f2', ak: '#a6e22e', bl: '#66d9ef', bn: '#f92672', gn: '#a6e22e', gy: '#75715e', ow: '#fd971f', pp: '#ae81ff', rd: '#f92672', sy: '#e6db74' },
  { name: 'Dracula', bg: '#282a36', fg: '#f8f8f2', ak: '#8be9fd', bl: '#bd93f9', bn: '#ff5555', gn: '#50fa7b', gy: '#6272a4', ow: '#ffb86c', pp: '#bd93f9', rd: '#ff5555', sy: '#f1fa8c' },
  { name: 'GitHub', bg: '#0d1117', fg: '#c9d1d9', ak: '#79c0ff', bl: '#d2a8ff', bn: '#ff7b72', gn: '#7ee787', gy: '#8b949e', ow: '#ffa657', pp: '#d2a8ff', rd: '#ff7b72', sy: '#d2a8ff' },
  { name: 'Nord', bg: '#2e3440', fg: '#eceff4', ak: '#88c0d0', bl: '#81a1c1', bn: '#bf616a', gn: '#a3be8c', gy: '#4c566a', ow: '#d08770', pp: '#b48ead', rd: '#bf616a', sy: '#ebcb8b' },
