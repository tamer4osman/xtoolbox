...
export const toolConfig = {
  ...
  steps: [
    "Enter an IP and CIDR prefix (e.g. 192.168.1.0/24)",
    "View network details instantly",
  ...
  faqs: [
    {
      ...
      answer:
        "CIDR (Classless Inter-Domain Routing) uses IP/prefix format, e.g. 192.168.1.0/24 means subnet mask 255.255.255.0."
    },
    {
      question: "What is the usable host range?",
      answer:
        "The range between network and broadcast addresses available for assigning to devices."
    }
  ]
};
