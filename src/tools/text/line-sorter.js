  ...
  faqs: [
    {
      ...
      answer: "A→Z, Z→A, Natural, Numeric, Reverse, Shuffle, Unique, and Trim."
    },
    {
      question: "Does it handle large inputs?",
      answer:
        "Yes. It sorts efficiently in the browser. Very large inputs may be slow with Shuffle mode."
    }
  ]
};
