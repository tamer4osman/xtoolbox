...
export const toolConfig = {
  ...
  faqs: [
    { question: 'Is this legal advice?', answer: 'No. This tool helps simplify language but does not provide legal interpretation or advice.' },
    { question: 'What types of legal text work best?', answer: 'Contract clauses, terms of service, privacy policies, and legal notices work best.' }
  ]
};
