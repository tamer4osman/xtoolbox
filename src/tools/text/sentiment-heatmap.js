...
export const toolConfig = {
  ...
  faqs: [
    { question: 'What do the colors mean?', answer: 'Green indicates positive sentiment, red indicates negative, and yellow/white is neutral.' },
    { question: 'What types of text work best?', answer: 'Reviews, feedback, opinions, and any text with emotional content.' }
  ]
};
