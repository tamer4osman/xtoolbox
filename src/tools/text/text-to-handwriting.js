export const toolConfig = {
  ...
  category: 'text',
  description: 'Convert text to handwritten-style images. Choose from different handwriting fonts.',
  icon: '✍',
  accept: '.txt',
  maxSizeMB: 5,
  keywords: ['text to handwriting', 'handwriting generator', ' handwritten text', 'font converter'],
...
export function render(container) {
  container.innerHTML = `
    <div class="handwriting-container">
      ...
      <div id="preview" class="handwriting-preview"></div>
    </div>
  `;
