...
export const toolConfig = {
  ...
  steps: ['Add assets (bank, investments, property)', 'Add liabilities (loans, credit cards)', 'View net worth chart over time'],
  faqs: [
    { question: 'Is my financial data stored anywhere?', answer: 'No. All data is stored in your browser. Nothing is sent to any server.' },
    { question: 'Can I export my data?', answer: 'Yes. You can export all data as JSON and import it back later.' }
  ]
};

export const ASSET_TYPES = ['Bank Account', 'Savings Account', 'Investment Account', 'Retirement Account', 'Real Estate', 'Vehicle', 'Other'];
export const LIABILITY_TYPES = ['Mortgage', 'Auto Loan', 'Student Loan', 'Credit Card', 'Personal Loan', 'Other'];
...
export function render(container) {
  ...
  addEntryBtn.addEventListener('click', () => {
    ...
    entries.push({ id: generateId(), type: entryType.value, name, amount, date: new Date().toISOString() });
    saveData(entries);
    entryName.value = '';
    entryAmount.value = '';
    renderEntries();
