...
export const toolConfig = {
  ...
  steps: [
    ...
    "Review your WPM and accuracy after 30 seconds"
  ],
  faqs: [
    {
      question: "How is WPM calculated?",
      answer: "WPM = (total characters typed / 5) / minutes elapsed."
    },
    {
      question: "What happens when time runs out?",
      answer: "The test stops at 30 seconds and shows your results."
    }
  ]
};
