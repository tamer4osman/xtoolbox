  ...
  faqs: [
    {
      ...
      answer:
        "A PDF where text is embedded as invisible layer over the scanned images, making it searchable and copyable."
    },
    {
      question: "Does it change the appearance?",
      answer:
        "No. The original scanned images are preserved. Text is added as an invisible overlay."
    }
  ]
};
...
export function render(container) {
  ...
  processBtn.addEventListener("click", async () => {
    ...
    try {
      ...
      showToast({
        message: `OCR complete! ${pages.length} pages processed. Text extracted as .txt file.`,
        type: "success"
      });
    } catch (err) {
