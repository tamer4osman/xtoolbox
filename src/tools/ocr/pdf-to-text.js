...
export const toolConfig = {
  ...
  faqs: [
    { question: 'Does this work on scanned PDFs?', answer: 'Scanned PDFs contain images, not text. Use "Image to Text" OCR for scanned documents.' },
    { question: 'Is formatting preserved?', answer: 'Basic text is extracted. Complex layouts may not retain formatting.' }
  ]
};
