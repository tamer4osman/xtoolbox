...
export const toolConfig = {
  ...
  steps: ['Log symptoms with date, severity, and notes', 'View timeline of symptoms', 'Export printable summary for your doctor'],
  faqs: [
    { question: 'Is this a medical diagnostic tool?', answer: 'No. This is a tracking tool to help you organize information for doctor visits.' },
    { question: 'Is my health data private?', answer: 'Yes. All data is stored in your browser and never leaves your device.' }
  ]
};

export const BODY_PARTS = ['Head', 'Eyes', 'Ears', 'Nose', 'Throat', 'Chest', 'Back', 'Abdomen', 'Arms', 'Hands', 'Legs', 'Feet', 'Skin', 'General'];
...
export function render(container) {
  ...
  function renderSymptoms() {
    ...
    symptomsList.innerHTML = sorted.length === 0
