...
export const toolConfig = {
  ...
  faqs: [
    {
      question: "Can I reset to original?",
      answer: 'Yes. Click the "Reset" button to restore original values.'
    }
  ]
};
...
export const render = createImageFilterTool({
  ...
  `,
  getFilter: t =>
    `brightness(${t.getValue("brightness")}%) contrast(${t.getValue("contrast")}%) saturate(${t.getValue("saturation")}%) blur(${t.getValue("blur")}px)`,
