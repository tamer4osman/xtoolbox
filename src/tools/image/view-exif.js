...
export const toolConfig = {
  ...
  faqs: [
    {
      question: "What information is in EXIF?",
      answer:
        "Camera model, lens, ISO, aperture, shutter speed, date/time, GPS coordinates, software, and more."
    },
    {
      question: "Do all images have EXIF data?",
      answer:
        "No. Screenshots, downloaded images, and heavily edited images often have no EXIF data."
    }
  ]
};
  ...
  const upload = createFileUpload({
    ...
    onFilesSelected: async files => {
      ...
      resultsArea.innerHTML =
        '<div style="text-align:center;padding:var(--space-4);"><div class="spinner"></div><p>Reading metadata...</p></div>';
