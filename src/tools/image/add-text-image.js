  ...
  faqs: [
    {
      ...
      answer: 'Yes. Click "Add Text" to add more layers.'
    }
  ]
};
...
function renderLayerControls(container, updatePreview) {
  ...
  layersArea.innerHTML = textLayers
    .map(
      (layer, i) => `
...
export const render = createImageTool({
  ...
  `,
  previewStyle:
    "text-align:center;margin:var(--space-4) 0;position:relative;display:inline-block;max-width:100%;cursor:move;",
