  ...
  faqs: [
    {
      ...
      answer:
        "GPS location, camera model, date taken, software info, thumbnails, and all other EXIF/IPTC/XMP data."
    },
    {
      question: "Does this affect image quality?",
      answer: "No. The image pixels are re-encoded identically. Only metadata is stripped."
    }
  ]
};
