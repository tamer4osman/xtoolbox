export function render(container) {
  const categories = {
    ...
    area: { name: 'Area', units: ['sqmeter', 'sqkilometer', 'sqfoot', 'sqyard', 'acre', 'hectare'] },
  ...
  let categoryOptions = Object.entries(categories).map(([key, val]) => 
  ...
  const conversions = {
    ...
    area: { sqmeter: 1, sqkilometer: 1000000, sqfoot: 0.092903, sqyard: 0.836127, acre: 4046.86, hectare: 10000 },
