...
export const toolConfig = {
  ...
  steps: ['Click Start Recording', 'Select screen or browser tab', 'Click Stop when done', 'Download WebM video'],
  faqs: [
    { question: 'What formats are supported?', answer: 'WebM (VP8/VP9) is the default format. Some browsers also support MP4.' },
    { question: 'Is audio recorded?', answer: 'Yes, system audio can be included if you select "Share audio" in the browser dialog.' }
  ]
};
