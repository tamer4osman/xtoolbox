...
export function render(container) {
  ...
  createVideoConverter({
    ...
    getPreviewHTML: (file) => `<img src="${URL.createObjectURL(file)}" style="max-width:100%;max-height:300px;border-radius:var(--radius-md);border:1px solid var(--color-border);">`,
