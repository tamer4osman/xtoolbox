...
export function render(container) {
  ...
  createVideoConverter({
    ...
    getInputFilename: (name) => 'input.webm',
    includeAudioCodec: true,
    getPreviewHTML: (file) => `<video controls style="max-width:100%;max-height:300px;border-radius:var(--radius-md);border:1px solid var(--color-border);">
