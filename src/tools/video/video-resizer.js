...
export const toolConfig = {
  ...
  name: 'Video Resizer',
  category: 'video',
  description: 'Change video resolution to any size. Choose from popular presets or enter custom dimensions.',
  icon: '📐',
  ...
  faqs: [
    { question: 'Does resizing reduce quality?', answer: 'Downscaling (e.g., 4K to 1080p) looks great. Upscaling (e.g., 720p to 1080p) may look blurry.' },
    { question: 'What resolutions are available?', answer: 'Presets from 240p up to 4K, or enter a custom width×height.' }
  ]
};
