...
export const toolConfig = {
  ...
  faqs: [
    { question: 'Are weekends always excluded?', answer: 'Yes. Saturday and Sunday are excluded by default. The country selector adds public holidays.' },
    { question: 'How accurate are the holidays?', answer: 'Holidays are approximate and may not include regional or moved holidays. Always verify critical dates.' }
  ]
};

export const HOLIDAYS = {
  US: [
    '01-01', '01-15', '02-19', '05-27', '06-19', '07-04', '09-01', '10-14', '11-11', '11-28', '12-25'
  ],
  UK: [
    '01-01', '01-02', '03-29', '04-01', '05-06', '05-27', '08-26', '12-25', '12-26'
  ],
  DE: [
    '01-01', '01-06', '03-29', '04-01', '05-01', '05-09', '05-20', '05-30', '10-03', '10-31', '11-01', '12-25', '12-26'
  ],
  FR: [
    '01-01', '04-01', '05-01', '05-08', '05-09', '05-30', '06-10', '07-14', '08-15', '11-01', '11-11', '12-25'
  ],
  JP: [
    '01-01', '01-02', '01-03', '01-08', '02-11', '02-12', '02-23', '03-20', '04-29', '05-03', '05-04', '05-05', '05-06', '07-15', '08-11', '09-16', '09-23', '10-14', '11-23', '11-24', '12-29', '12-30', '12-31'
  ],
  IN: [
    '01-26', '03-25', '03-29', '04-11', '04-14', '04-17', '04-21', '05-01', '05-23', '06-17', '08-15', '10-02', '10-20', '11-01', '11-15', '12-25'
  ],
  AU: [
    '01-01', '01-26', '03-29', '04-01', '04-25', '06-09', '12-25', '12-26'
  ],
  BR: [
    '01-01', '02-12', '02-13', '03-29', '04-21', '05-01', '06-20', '09-07', '10-12', '11-02', '11-15', '12-25'
  ],
  CA: [
    '01-01', '02-19', '03-29', '05-20', '06-21', '07-01', '09-02', '10-14', '11-11', '12-25', '12-26'
  ],
  CN: [
    '01-01', '02-10', '02-11', '02-12', '02-13', '02-14', '02-15', '02-16', '02-17', '04-04', '04-05', '05-01', '05-02', '05-03', '06-08', '06-09', '06-10', '09-15', '10-01', '10-02', '10-03', '10-04', '10-05', '10-06', '10-07'
  ]
};
