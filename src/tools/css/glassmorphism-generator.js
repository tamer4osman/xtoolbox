const BACKGROUNDS = [
  ...
  { name: 'Gradient Midnight', value: 'linear-gradient(135deg, #0f0c29 0%, #302b63 50%, #24243e 100%)' },
...
export const toolConfig = {
  ...
  category: 'css',
  description: 'Interactive studio for generating cross-browser glassmorphism (frosted glass) CSS with Safari fallbacks.',
  icon: '🔮',
  accept: null,
  maxSizeMB: null,
  keywords: ['glassmorphism', 'frosted glass', 'css glass effect', 'backdrop-filter', 'glass generator', 'safari glass'],
  steps: ['Choose a background', 'Adjust blur, opacity, and radius sliders', 'Copy the generated CSS code'],
  faqs: [
    { question: 'What is glassmorphism?', answer: 'Glassmorphism is a UI design trend that creates a frosted glass effect using backdrop-filter: blur().' },
    { question: 'Why does Safari need special handling?', answer: 'Safari requires the -webkit- prefix for backdrop-filter. Our generator includes both standard and prefixed rules.' },
    { question: 'Does this work on all browsers?', answer: 'Yes! Chrome, Firefox, Edge support backdrop-filter natively. Safari requires -webkit-backdrop-filter which we include.' }
  ]
};
