...
describe('css-animation-generator', () => {
  describe('generateCSS', () => {
    it('returns string with @keyframes', () => {
      const css = generateCSS('from { opacity: 0; } to { opacity: 1; }', { duration: 1, delay: 0, easing: 'ease', iterations: 'infinite', direction: 'normal', fillMode: 'none' });
    ...
    it('includes custom duration', () => {
      const css = generateCSS('from { opacity: 0; } to { opacity: 1; }', { duration: 2.5, delay: 0.5, easing: 'ease-in', iterations: '3', direction: 'alternate', fillMode: 'forwards' });
