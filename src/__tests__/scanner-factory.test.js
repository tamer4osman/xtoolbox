...
describe("createScanner", () => {
  ...
  it("exposes showResult helper that displays text and metadata", () => {
    ...
    expect(container.querySelector("#test-scanner-result").classList.contains("hidden")).toBe(
      false
    );
  });
  ...
  it("exposes showError helper that displays error message", () => {
    ...
    expect(container.querySelector("#test-scanner-error-message").textContent).toBe(
      "No code found"
    );
