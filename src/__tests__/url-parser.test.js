...
describe("url-parser", () => {
  ...
  describe("buildUrl", () => {
    it("builds basic URL", () => {
      expect(buildUrl({ protocol: "https", hostname: "example.com", pathname: "/api" })).toBe(
    ...
    it("builds URL with params", () => {
      expect(
        buildUrl({ protocol: "https", hostname: "example.com", params: { q: "test", page: "2" } })
      ).toBe("https://example.com/?q=test&page=2");
    });

    it("builds URL with hash", () => {
      expect(
        buildUrl({ protocol: "https", hostname: "example.com", pathname: "/page", hash: "top" })
