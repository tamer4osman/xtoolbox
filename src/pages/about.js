...
export function renderAbout() {
  ...
  updatePageMeta({
    ...
    description: 'Learn about XToolBox — 311 free online tools with complete privacy. All processing happens in your browser.',
    ...
    <div class="container page-content" style="max-width:800px;">
      ...
      <div style="color:var(--color-text-secondary);line-height:1.8;">
        <p style="margin-bottom:var(--space-4);font-size:var(--text-lg);">
          XToolBox is a collection of 311 free online tools that run entirely in your browser. No uploads, no servers, no privacy concerns.
        </p>
